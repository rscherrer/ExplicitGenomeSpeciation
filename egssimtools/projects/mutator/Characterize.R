...
ggsave("projects/mutator/heatmaps.png", width = 5, height = 6, dpi = 300)
...
ggsave("projects/mutator/lineplots_additive.png", plots[[1]], width = 16, height = 9, dpi = 400)
ggsave("projects/mutator/lineplots_intermediate.png", plots[[2]], width = 16, height = 9, dpi = 400)
ggsave("projects/mutator/lineplots_epistatic.png", plots[[3]], width = 16, height = 9, dpi = 400)
...
ggsave("projects/mutator/phaseplots_ecospatial_additive.png", plots[[1]], width = 6, height = 5, dpi = 300)
ggsave("projects/mutator/phaseplots_ecospatial_intermediate.png", plots[[2]], width = 6, height = 5, dpi = 300)
ggsave("projects/mutator/phaseplots_ecospatial_epistatic.png", plots[[3]], width = 6, height = 5, dpi = 300)
...
ggsave("projects/mutator/phaseplots_ecorepro_additive.png", plots[[1]], width = 6, height = 8.5, dpi = 400)
ggsave("projects/mutator/phaseplots_ecorepro_intermediate.png", plots[[2]], width = 6, height = 8.5, dpi = 400)
ggsave("projects/mutator/phaseplots_ecorepro_epistatic.png", plots[[3]], width = 6, height = 8.5, dpi = 400)
