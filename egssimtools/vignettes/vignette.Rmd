...
## 1. Plot speciation metrics through time 
...
## 2. Plot trait distributions through time
...
## 3. Compare genome-wide Fst across simulations
...
```{r}
data <- pivot_data(data, variables[-1], newnames = newnames)
data <- data %>% rename(trait = "variable")
tibble(data)
...
### 4. Compare genome scans across simulations
...
### 5. Compare Fst through time across traits and simulations
