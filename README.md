...
---|---|---
master|[![Build Status](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation.svg?branch=master)](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation)|[![codecov.io](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/coverage.svg?branch=master)](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/branch/master)
develop|[![Build Status](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation.svg?branch=develop)](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation)|[![codecov.io](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/coverage.svg?branch=develop)](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/branch/develop)
raph|[![Build Status](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation.svg?branch=raph)](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation)|[![codecov.io](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/coverage.svg?branch=raph)](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/branch/raph)
thijs|[![Build Status](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation.svg?branch=thijs)](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation)|[![codecov.io](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/coverage.svg?branch=thijs)](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/branch/thijs)
richel|[![Build Status](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation.svg?branch=richel)](https://travis-ci.com/rscherrer/ExplicitGenomeSpeciation)|[![codecov.io](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/coverage.svg?branch=richel)](https://codecov.io/github/rscherrer/ExplicitGenomeSpeciation/branch/richel)
...
The program has the option to perform a _pedigree experiment_ every `tpedigree` generation if `pedigreesave` is 1. This experiment samples `pedigreetrials` random mating pairs of males and females and produce `pedigreeoffspring` juveniles out of these crosses, to characterize the distribution of offspring phenotypes. The output is saved in `pedigreefile` as binary data consisting of, for each mating event, the indices of the female and of the male, the ecotypes of the female and of the male, the three trait values of the female, the three trait values of the male, and then for each of their offspring the three trait values of that offspring.
